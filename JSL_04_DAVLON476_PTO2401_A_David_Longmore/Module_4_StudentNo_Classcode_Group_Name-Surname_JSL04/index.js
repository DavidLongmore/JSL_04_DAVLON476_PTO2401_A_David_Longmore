...
switch (userPreference) {
    case "Sugar-free":
        console.log('I prefer Sugar-free!');
        break;
    case "Regular":
        console.log('I prefer Regular!');
        break;
    default:
        console.log('I prefer Regular')
}
...
const canRestock = cansLeft < 5 ? "Time to restock!" : "We're stocked";
console.log(canRestock);
...
const suggestedTemp = currentTemp <= 5 ? "Chilled to perfection!" : "Needs a cooler!";
...
const monsterTime = currentHour <= 7 ? "Better stick to water" : "Unleash the beast!";
